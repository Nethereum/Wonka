...
contract WonkaEngineOpt is ERC2746 {
	...
	/// @dev This method will return the stored record value.
    /// @notice This method should only be used for debugging purposes.
    function getStoredRecordValue() public view returns(string memory) {
        return storedValue;
    }	
    ...
    function getValueOnRecord(address ruler, bytes32 key) public returns(string memory) { 
        ...
        storedValue = wonkaRuleSets.getValueOnRecord(ruler, key);
        return storedValue;
    }
