...
* Orchestration 'get' functionality in the Ethereum engine, where the RuleTree can be directed to assemble a virtual record by pulling values from other contracts within the blockchain.
* Orchestration 'set' functionality in the Ethereum engine, where the RuleTree can be directed to set values on other contracts within the blockchain.
* Orchestration 'custom' functionality in the Ethereum engine, where the RuleTree can execute a user-defined rule by calling a function on another contract within the blockchain.
